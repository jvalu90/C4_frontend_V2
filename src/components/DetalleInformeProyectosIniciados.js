...
const baseUrl='http://localhost:9000/projects/iniciados?page=1&limit=10000'
...
function DetalleInformeProyectosIniciados() {
...
export default DetalleInformeProyectosIniciados;
